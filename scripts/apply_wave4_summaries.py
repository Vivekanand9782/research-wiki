...
from scripts.summaries_wave4_part1 import wave4_part1
from scripts.summaries_wave4_part2 import wave4_part2
from scripts.summaries_wave4_part3 import wave4_part3

all_wave4 = {}
all_wave4.update(wave4_part1)
all_wave4.update(wave4_part2)
all_wave4.update(wave4_part3)

print(f"Total Wave 4 summaries to write & validate: {len(all_wave4)}")
...
for filename, content in all_wave4.items():
    # 1. Validate
