...
metadata_file = Path("raw/next_twenty_papers_metadata.json")

# Slice from 20 to 40
files = sorted(f for f in os.listdir(RAW_DIR) if f.endswith(".md") and not f.startswith("."))[20:40]
...
print("\nSaved metadata to raw/next_twenty_papers_metadata.json")
