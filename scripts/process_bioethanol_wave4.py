"""Orchestration script to write all 15 Wave 4 bioethanol summaries, validate, and mark done."""
...
from scripts.bioethanol_wave4_batch1 import W4_BATCH_1
from scripts.bioethanol_wave4_batch2 import W4_BATCH_2
from scripts.bioethanol_wave4_batch3 import W4_BATCH_3

WIKI_DIR = Path("wiki/sources/uncategorized")
WIKI_DIR.mkdir(parents=True, exist_ok=True)

ALL_SUMMARIES = {}
ALL_SUMMARIES.update(W4_BATCH_1)
ALL_SUMMARIES.update(W4_BATCH_2)
ALL_SUMMARIES.update(W4_BATCH_3)

print(f"Total Wave 4 summaries to process: {len(ALL_SUMMARIES)}")
