"""Orchestration script to write all 15 bioethanol summaries, validate, and mark done."""
...
from scripts.bioethanol_batch1 import BATCH_1
from scripts.bioethanol_batch2 import BATCH_2
from scripts.bioethanol_batch3 import BATCH_3

WIKI_DIR = Path("wiki/sources/uncategorized")
WIKI_DIR.mkdir(parents=True, exist_ok=True)

ALL_SUMMARIES = {}
ALL_SUMMARIES.update(BATCH_1)
ALL_SUMMARIES.update(BATCH_2)
ALL_SUMMARIES.update(BATCH_3)
